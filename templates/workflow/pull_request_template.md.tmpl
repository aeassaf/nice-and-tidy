...
<!--
  No ticketing system yet, so either form is accepted:
    - a ticket link:  # [PROJ-123](https://…) - Ticket title
    - or a short description of the task this PR does.
  Never invent a ticket number to fill this in. Describing the task is the correct
  answer when no ticket exists.
-->
...
<!-- Steps in bullet points. Commands in fenced blocks so they can be copy-run. -->
