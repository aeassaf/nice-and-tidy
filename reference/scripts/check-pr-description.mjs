 ...
 *
 * Deliberately dependency-free and outside the pnpm workspace globs (`apps/*`,
 * `packages/*`): no package.json, no tsconfig, no eslint wiring, no vitest. It runs
 * on the Node 22 already pinned in `engines`. Its tests run under `node --test`.
 *
 * Usage:
