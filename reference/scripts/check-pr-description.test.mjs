 ...
 *
 * Following the convention set by packages/theme/gates: a gate is only trustworthy if
 * something proves it FAILS on a deliberate violation. Most of these are negative
